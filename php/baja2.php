...
$registros = mysqli_query($conexion, "select * from alumnos where mail='$mail' ") or die("No se pudo conectar a la base de datos");
if(mysqli_fetch_array($registros)){
    mysqli_query($conexion, "delete from alumnos where mail='$mail' ") or die("No se pudo eliminar");
